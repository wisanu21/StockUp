                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">ยินดีต้อนรับสู่ Stock UP !</h1>
                                    </div>

                                    {!! Form::open(['url'=>url("/login"), 'method', 'POST', 'class' => 'form', 'enctype' => 'multipart/form-data']) !!}
                                        <div class="form-group">
                                            <input type="text" name = "phone_number" class="form-control form-control-user"
                                                placeholder="เบอร์โทรศัพท์...">
                                                {!! showError('phone_number',$errors) !!}
                                        </div>
                                        <div class="form-group">
