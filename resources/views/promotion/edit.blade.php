            ...
            <div class="col-xl-10 col-lg-10 col-sm-12">
                <div class="card shadow mb-3">
                    <div class="card-header py-2">
                        <h6 class="m-0 font-weight-bold text-secondary"> <i class="fas fa-plus"></i> เพิ่มโปรโมชั่น</h6>
                    </div>
                    <div class="card-body">
                        {!! Form::open(['url'=>url("/promotion/edit-save"), 'method', 'POST', 'class' => 'form', 'enctype' => 'multipart/form-data']) !!}
                            {!! Form::hidden('id',$promotion->id)!!}
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    {!! Form::text('name',old('name',$promotion->name),['class'=> 'form-control form-control-user', 'placeholder'=>'ชื่อโปรโมชั่น']) !!}
                                    {!! showError('name',$errors) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-8">
                                    {!! Form::text('resource',old('resource',$promotion->resource),['class'=> 'form-control form-control-user', 'placeholder'=>'จำนวนส่วนลด']) !!}
                                ...
                                <div class="col-sm-4">
                                    ...
                                    {!! Form::select('price_or_percentage', $price_or_percentages, old('price_or_percentage',$promotion->price_or_percentage), ['class'=> 'form-control form-control-user']) !!}
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    ...
                                    {!! Form::select('is_active_promotion', $is_active_promotions, old('is_active_promotion',$promotion->is_active_promotion), ['class'=> 'form-control form-control-user']) !!}
                                    {!! showError('is_active_promotion',$errors) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-8">
                                    {!! Form::text('code',old('code',$promotion->code),['class'=> 'form-control form-control-user', 'placeholder'=>'โค้ดส่วนลด']) !!}
                                    {!! showError('code',$errors) !!}
                                </div>
                                <div class="col-sm-4">
                                    <?php $is_active_codes = [""=>"-- กรุณาเลือกสถานะการใช้งานโค้ดส่วนลด --" , "1"=>"เปิดใช้งานโค้ดส่วนลด" , "0"=>"ปิดใช้งานโค้ดส่วนลด"]; ?>
                                    {!! Form::select('is_active_code', $is_active_codes, old('is_active_code',$promotion->is_active_code), ['class'=> 'form-control form-control-user']) !!}
