                ...
                <div class="card shadow mb-3">
                    ...
                    {!! Form::open(['url'=>url("/promotion/add-save"), 'method', 'POST', 'class' => 'form', 'enctype' => 'multipart/form-data']) !!}
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        {!! Form::text('name',old('name'),['class'=> 'form-control form-control-user', 'placeholder'=>'ชื่อโปรโมชั่น']) !!}
                                        {!! showError('name',$errors) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-8">
                                        {!! Form::text('resource',old('resource'),['class'=> 'form-control form-control-user', 'placeholder'=>'จำนวนส่วนลด']) !!}
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        {!! Form::select('price_or_percentage', $price_or_percentages, old('price_or_percentage'), ['class'=> 'form-control form-control-user']) !!}
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        {!! Form::select('is_active_promotion', $is_active_promotions, old('is_active_promotion'), ['class'=> 'form-control form-control-user']) !!}
                                        {!! showError('is_active_promotion',$errors) !!}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-8">
                                        {!! Form::text('code',old('code'),['class'=> 'form-control form-control-user', 'placeholder'=>'โค้ดส่วนลด']) !!}
                                        {!! showError('code',$errors) !!}
                                    </div>
                                    <div class="col-sm-4">
                                        <?php $is_active_codes = [""=>"-- กรุณาเลือกสถานะการใช้งานโค้ดส่วนลด --" , "1"=>"เปิดใช้งานโค้ดส่วนลด" , "0"=>"ปิดใช้งานโค้ดส่วนลด"]; ?>
                                        {!! Form::select('is_active_code', $is_active_codes, old('is_active_code'), ['class'=> 'form-control form-control-user']) !!}
